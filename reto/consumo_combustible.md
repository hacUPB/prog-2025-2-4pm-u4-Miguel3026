...
fases = ["ascenso", "crucero", "descenso"]
consumos = [75, 50, 37]
tiempos = [t_ascenso, t_crucero, t_descenso]

# Bucle para las fases del vuelo
for nombre, tiempo, consumo in zip(fases, tiempos, consumos):
    combustible_act, tiempo_total, estado = simular_fase(
        nombre, tiempo, consumo,
        combustible_act, tiempo_total, intervalo, min_seguridad
    )
    if estado == "Vuelo fallido":
        return
